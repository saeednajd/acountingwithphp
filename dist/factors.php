						...
						<div class="col-xl-6 mb-5 mb-xl-10" style="    justify-content: center;width: 70vw;">
											...
											<div class="card h-xl-100">
												...
												<h3 class="card-title align-items-start flex-column ">
													<span class="card-label fw-bold fs-3 mb-1 "> فاکتور ها</span>
													<?php
													...
													<div class="text-info fw-bold mb-0 mt-5">
														تعداد فاکتور ها :
																<?php
																	include_once "./control/invoices.php";
																	
																	$invoicesnum=invoicesnum();
																	echo $invoicesnum->num_rows;
																?>
															</div>
												</h3>
											...
											<div class="card-body py-3">
												...
												<div class="table-responsive">
													...
													<table class="table align-middle gs-0 gy-3 table-bordered table-striped border-dark align-middle gs-0 gy-3">
														<!--begin::Table head-->
														<thead>
															...
															<tr class="text-center text-success fs-4">
																...
																<th class="">نام محصولات خریداری شده </th>
																<th class="">مبلغ فاکتور </th>
																<th class="">حذف</th>
														...
														<tbody>
															<?php
																...
																while($showinvoicesrow=$showinvoices->fetch_assoc()){
															...
															<tr class="text-center">
																...
																<td>
																	<a href="#" class="text-dark fw-bold text-hover-primary mb-1 fs-6">
																		<?php
																			echo $showinvoicesrow["customername"];
																		?>
																	</a>
																</td>
																<td class=" fw-bold">
																...
																<td class=" fw-bold">
                                                                    ...
                                                                    include_once "./control/products.php";
																		$prids=$showinvoicesrow["productsid"];
                                                                        $prid= explode(",", $prids);
                                                                        $i = 0;
                                                                        while ($i < count($prid)) {
                                                                            showproductsbyid($prid[$i]);
                                                                            echo "<br>";
                                                                            $i++;
                                                                        } 
																	?>
                                                                ...
                                                                <td class=" fw-bold">
                                                                        ...
                                                                        <?php
																			echo $showinvoicesrow["price"];
																		?>
																	
																</td>
																<td class=" fw-bold">
																<?php
																		$customerid=$showinvoicesrow["id"];
																?>
																	<a href=<?php echo "./control/deleteinvoices.php?customerid=".$customerid; ?>>
