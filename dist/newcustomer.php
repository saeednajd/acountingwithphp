								...
								<div class="card">
									...
									<div class="card-body p-lg-17">
										...
										<div class="row mb-3">
											...
											<div class="pe-lg-10">
												<!--begin::Form-->
												<form action="./control/newcustomer.php" class="form mb-15" method="POST" id="kt_contact_form">
													<h1 class="fw-bold text-info mb-9 text-center">افزودن مشتری جدید</h1>
													<?php
														if(isset($_GET["error"])){
															echo '<h1 class="fw-bold text-center text-danger mb-9 ">* ثبت با مشکل مواجه شد *</h1>';
														}elseif(isset($_GET["success"])){
															echo '<h1 class="fw-bold text-center text-success mb-9 ">* مشتری جدید با موفقیت اضافه شد *</h1>';
													...
													<div class="row mb-5">
														...
														<div class="fv-row">
															<!--begin::Tags-->
															<label class="fs-5 fw-semibold mb-2">نام مشتری</label>
															<!--end::Tags-->
															<!--begin::Input-->
														...
														<div class="col-md-6 fv-row mt-3">
															<!--end::Tags-->
															<label class="fs-5 fw-semibold mb-2">تلفن </label>
															<!--end::Tags-->
															<!--end::Input-->
															<input type="text" class="form-control form-control-solid border border-primary" name="phone">
															<!--end::Input-->
														</div>
                                                        <div class="col-md-6 fv-row mt-3">
															<!--end::Tags-->
															<label class="fs-5 fw-semibold mb-2">آدرس</label>
															<!--end::Tags-->
															<!--end::Input-->
															<input type="text" class="form-control form-control-solid  border border-primary"  name="address">
															<!--end::Input-->
														</div>
													...
													<input type="submit" class="btn btn-primary"  name="submit" value="ثبت مشتری">
