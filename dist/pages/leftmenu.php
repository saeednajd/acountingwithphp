									...
									<div class="menu menu-column menu-rounded menu-sub-indention fw-semibold fs-6" id="#kt_aside_menu" data-kt-menu="true">
										...
										<div data-kt-menu-trigger="click" class="menu-item here show menu-accordion">
											...
											<span class="menu-link">
												...
												<span class="menu-title"> امکانات</span>
											...
											<div class="menu-sub menu-sub-accordion">
												...
												<div class="menu-item">
													<!--begin:Menu link-->
													<a class="menu-link" href="allcustomers.php">
														<span class="menu-bullet">
															<span class="bullet bullet-dot"></span>
														</span>
												...
												<div class="menu-item">
													<!--begin:Menu link-->
													<a class="menu-link" href="newcustomer.php">
														<span class="menu-bullet">
															<span class="bullet bullet-dot"></span>
														</span>
												...
												<div class="menu-item">
													<!--begin:Menu link-->
													<a class="menu-link" href="allproducts.php">
														<span class="menu-bullet">
															<span class="bullet bullet-dot"></span>
														</span>
													...
													<!--begin:Menu link-->
													<a class="menu-link" href="newproduct.php">
														<span class="menu-bullet">
															<span class="bullet bullet-dot"></span>
														</span>
												...
												<div class="menu-item">
													...
													<a class="menu-link" href="./CommingSoon.php">
														...
														<span class="menu-title">فاکتور ها</span>
													</a>
													<!--end:Menu link-->
												</div>
												<div class="menu-item">
													...
													<a class="menu-link" href="./CommingSoon.php">
														...
														<span class="menu-title"> ارسالی های پستی</span>
													</a>
													<!--end:Menu link-->
												</div>
												<!--end:Menu item-->
