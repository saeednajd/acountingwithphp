						...
						<!--end::کناری-->
									<div class="col-xl-6 mb-5 mb-xl-10" style="    justify-content: center;width: 70vw;">
											...
											<div class="card h-xl-100">
												...
												<div class="searchpro ">
													<label for="search-pr">جست و  جو در محصولات</label>
											...
											<div class="card-body py-3">
												...
												<div class="table-responsive">
													<!--begin::Table-->
													<table class="table align-middle gs-0 gy-3 table-bordered border-dark align-middle gs-0 gy-3" id="myTable">
														<!--begin::Table head-->
														<thead>
															...
															<tr class="text-center text-success fs-4">
																...
																<th class="">قیمت خرید</th>
																<th class="">قیمت تمام شده</th>
																<th class="">موجودی انبار</th>
														...
														<tbody>
															<?php
																...
																while($showproductsrow=$showproducts->fetch_assoc()){

																
															?>
															<tr class="text-center" data-all-products>
																
																<td>
																	<a href="#" class="text-dark fw-bold text-hover-primary mb-1 fs-6">
																		<?php
																			echo $showproductsrow["name"];
																		?>
																	</a>
																</td>
																<td class=" fw-bold">
																<?php
																		require_once './jDateTime-master/jdatetime.class.php';
																			$time= $showproductsrow["dateofbuying"];
																			// تبدیل تاریخ MySQL به تاریخ شمسی
																			$jDate = new jDateTime(true, true, 'Asia/Tehran');
																			$shamsiDate = $jDate->date("Y/m/d", strtotime($time));
																			echo $shamsiDate; // نمایش تاریخ شمسی
																		?>
																</td>
																<td class=" fw-bold">
																	<?php
																		echo $showproductsrow["priceofproduct"];
																	?>
																	تومان
																</td>
																<td class="text-dark fw-bold fs-6 pe-0">
																	<?php
																		$mainprice=$showproductsrow["priceofproduct"];
																		$priceofpacking=$showproductsrow["priceofpacking"];
																		$priceoftransportation=$showproductsrow["priceoftransportation"];
																		$extraprices=$showproductsrow["extraprices"];
																		$finalprice=$mainprice+$priceofpacking+$priceoftransportation+$extraprices;
																		echo $finalprice;
																...
																<td class="text-dark fw-bold fs-6 pe-0">
																	<?php
																		echo $showproductsrow["inventory"];
																	?>
																	عدد
																</td>
																<td class="text-dark fw-bold fs-6 pe-0">
																	<?php
																		echo $showproductsrow["category"];
																	?>
																...
																<td>
																<?php
																		$prid=$showproductsrow["id"];
																	?>
																	<a href=<?php echo "./control/delete.php?prid=".$prid; ?>>
																		<div class="symbol symbol-50px me-2">
																			<span class="symbol-label bg-light-success">
																				<i class="ki-duotone ki-basket fs-2x text-danger">
																					<span class="path1"></span>
...
<!-- lawliet js -->
<script src="./prjs/searchbox.js"></script>
